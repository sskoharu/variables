...
namespace MVC6.Controllers
{
    public class ClienteController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Cedula_RUC,Nombre,Apellido,Direccion,Telefono,Edad")] ClienteModel clienteModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Cedula_RUC,Nombre,Apellido,Direccion,Telefono,Edad")] ClienteModel clienteModel)
        {
